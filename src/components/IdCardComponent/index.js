...
//       }
//    else {
//       console.warn('html2pdf cannot be used in Node.js environment');
//   }
// }
    ...
    >
      ...
      <div className="hidden">
        <div ref={idCardRef} className="bg-white h-[1000px] relative">
          ...
          {/* Background Image */}
          <Image src="/images/Green Minimalist School ID Card (1).svg" width={600} height={400} alt='image' className="absolute ml-[28%] h-[230px] w-[350px] object-cover z-0" />

          {/* ID Card Content */}
          <div className="id-card flex mx-auto mt-8 h-[230px] w-[350px] relative z-10">
            {/* Content goes here */}
            <Image className="absolute w-[25.6%] h-[88px] mt-[88px] ml-[7.8%]" alt='image' src={user?.imageUrl} width={600} height={400} />
