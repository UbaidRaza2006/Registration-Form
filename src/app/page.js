...
export default function MainPage() {
    ...
    const [crop, setCrop] = useState({ aspect: 4 / 5 }); // Fixed aspect ratio for passport-size
...
>
      {!image ? (
        ...
        <div className="crop-container">
          ...
          />
          <button onClick={handleImageCropAndUpload} className="upload-btn">
